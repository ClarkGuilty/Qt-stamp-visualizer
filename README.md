...
For detailed documentation, go to the [redmine](https://euclid.roe.ac.uk/projects/dr1-kp-sl-1/wiki/Visualization_tool_for_RR2_inspection) (requires login with ESA credentials).
